...
export class FileGenerator {
  constructor(options = {}) {
    this.options = {
      templatesRoot: path.join(process.cwd(), "cli", "templates"),
  ...
  async _prepareContext(config) {
    ...
    if (config.frontend) {
      context.isReact = config.frontend === "react";
      context.isVue = config.frontend === "vue";
      context.isAngular = config.frontend === "angular";
      context.isNextjs = config.frontend === "nextjs";
    }
