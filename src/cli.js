...
program
  ...
  .option('--database <type>', chalk.gray('Database: sqlite, postgres, mysql, mongodb, none'))
  .option('--orm <type>', chalk.gray('ORM: prisma, sequelize, mongoose, typeorm, none'))
  .option('--backend <type>', chalk.gray('Backend: express, fastify, koa, hapi, nestjs, none'))
  .option('--frontend <types...>', chalk.gray('Frontend: react, vue, angular, svelte, nextjs, nuxt'))
  .option('--auth <type>', chalk.gray('Auth: jwt, passport, auth0, firebase, none'))
  .option('--addons <addons...>', chalk.gray('Tools: eslint, prettier, husky, docker, testing'))
