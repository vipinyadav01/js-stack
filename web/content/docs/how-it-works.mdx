---
title: How It Works
description: "The template-layering model behind every generated project: how base, framework, database and addon layers merge into one working codebase."
seoTitle: "How Layered Project Templates Work"
keywords: "project template engine, handlebars templates, layered scaffolding, package.json merge, full-stack boilerplate generator"
---
...
<Callout title="Example">
  ...
  <code>react-dom</code> (frontend), <code>express</code> + <code>cors</code> +{" "}
  <code>helmet</code> (backend), and <code>mongoose</code> (ORM) — all in a
  single, valid <code>package.json</code>.
</Callout>
