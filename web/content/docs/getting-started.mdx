...
- Frontend framework selection (React, Next.js, Vue, etc.)
- Backend framework selection (Express, Fastify, NestJS, etc.)
- Database and ORM setup
- Authentication configuration
- Additional addons (Docker, Testing, Biome, Turborepo)
...
Use our [interactive web builder](/new) to visually select your stack and get the exact command to run.
