...
export const metadata: Metadata = {
  title: {
    default: "JS-Stack CLI – Full-Stack Generator for JavaScript & Java",
  ...
  openGraph: {
    title: "JS-Stack CLI – Full-Stack Generator for JavaScript & Java",
    description:
      "One CLI for JavaScript, TypeScript and Java stacks. Scaffold React, Next.js or Vue frontends with Express, NestJS or Spring Boot backends, databases, auth and Docker.",
    url: siteUrl,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "JS-Stack CLI – full-stack app generator for JavaScript and Java",
        type: "image/png",
      },
    ],
  },
