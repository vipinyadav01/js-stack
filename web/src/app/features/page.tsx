...
const TECH_STACK: TechItem[] = [
  // Frontends
  {
    ...
    version: "15+",
    description:
      "Full-stack React framework with App Router, SSR & Server Actions",
    icon: "▲",
    badge: "Recommended",
  },
  {
    ...
    category: "frontend",
    version: "19+",
    description: "Modern React with Vite, TypeScript & Concurrent Features",
    icon: "⚛️",
    badge: "Popular",
  },
  {
    ...
    category: "frontend",
    version: "3+",
    description: "Vue 3 with Composition API, Script Setup & Vite tooling",
    icon: "💚",
  },
  {
    name: "Angular",
    category: "frontend",
    version: "18+",
    description: "Enterprise-grade TypeScript framework with modern signals",
    icon: "🅰️",
  },
  {
    name: "Svelte 5",
    category: "frontend",
    version: "5+",
    description: "Cybernetically enhanced web apps with reactive runes",
    icon: "🔥",
  },
  {
    name: "Nuxt 3",
    category: "frontend",
    version: "3+",
    description: "Intuitive Vue full-stack framework with auto-imports",
    icon: "💚",
  },
  {
    name: "Remix",
    category: "frontend",
    version: "2+",
    description: "Full-stack web framework focused on web standards & UX",
    icon: "💿",
  },
  {
    name: "Astro",
    category: "frontend",
    version: "4+",
    description: "Content-driven web framework with island architecture",
    icon: "🚀",
  },
  {
    name: "Solid.js",
    category: "frontend",
    version: "1.8+",
    description: "Declarative, efficient and flexible JS library for UI",
    icon: "🔵",
  },
  {
    name: "React Native",
    category: "frontend",
    version: "0.74+",
    description: "Cross-platform mobile apps with NativeWind styling",
    icon: "📱",
  },
  ...
  },
  {
    ...
    category: "backend",
    version: "4+",
    description: "High-performance Node.js framework focused on low overhead",
    icon: "⚡",
    badge: "High Speed",
  },
  {
    ...
    category: "backend",
    version: "10+",
    description: "Progressive Node.js framework for enterprise architectures",
    icon: "🪶",
  },
  {
    name: "Koa.js",
    category: "backend",
    version: "2+",
    description: "Next generation web framework designed by Express team",
    icon: "🌿",
  },
  {
    name: "Hono",
    category: "backend",
    version: "4+",
    description: "Ultrafast web framework for Cloudflare Workers & Node.js",
    icon: "🔥",
  },
  {
    name: "Elysia.js",
  ...
  // Databases
  {
    name: "PostgreSQL",
    category: "database",
    description: "World's most advanced open-source relational SQL database",
    icon: "🐘",
    badge: "Recommended",
  },
  {
    ...
    category: "database",
    description:
      "Scalable NoSQL document database for modern cloud applications",
    icon: "🍃",
    badge: "Popular",
  },
  {
    name: "SQLite",
    category: "database",
    description: "Lightweight, zero-config embedded SQL database engine",
    icon: "📦",
  },
  {
    name: "MySQL",
    category: "database",
    description: "Proven, enterprise relational database management system",
    icon: "🐬",
  },
  ...
  // ORMs
  {
    ...
    category: "orm",
    description:
      "Next-generation ORM with automated migrations & end-to-end types",
    icon: "⚡",
    badge: "Recommended",
  },
  {
    ...
    category: "orm",
    description:
      "Elegant MongoDB object modeling for Node.js with strict schemas",
    icon: "🍃",
  },
  {
    name: "Drizzle ORM",
    category: "orm",
    description:
      "Headless TypeScript ORM with maximum performance & zero overhead",
    icon: "🌧️",
    badge: "Modern",
  },
  {
    ...
    category: "orm",
    description:
      "Decorator-based ORM supporting Data Mapper & Active Record patterns",
    icon: "🔷",
  },
  {
    name: "Sequelize",
    category: "orm",
    description: "Promise-based Node.js ORM for Postgres, MySQL, SQLite",
    icon: "🔵",
  },
  ...
  // Auth
  {
    ...
    category: "auth",
    description:
      "Comprehensive TypeScript-first auth framework with multi-tenant sessions",
    icon: "🛡️",
    badge: "Recommended",
  },
  {
    ...
    category: "auth",
    description:
      "Complete user management & authentication platform with UI components",
    icon: "🔐",
  },
  {
    name: "Lucia Auth",
    category: "auth",
    description:
      "Flexible session management library that connects directly to your DB",
    icon: "🔑",
  },
  {
    ...
    category: "auth",
    description:
      "Flexible authentication library for Next.js and full-stack apps",
    icon: "🔒",
  },
  {
    name: "JWT + OAuth",
  ...
  // Addons
  {
    ...
    category: "addons",
    description:
      "Containerized development & production environment configurations",
    icon: "🐳",
    badge: "Recommended",
  },
  {
    name: "Biome",
    category: "addons",
    description: "Ultra-fast linter & formatter replacing ESLint and Prettier",
    icon: "⚡",
  },
  {
    name: "Turborepo",
  ...
  },
  {
    ...
    category: "addons",
    description:
      "Blazing fast unit & integration testing framework powered by Vite",
    icon: "🧪",
  },
  {
    name: "Playwright",
    category: "addons",
    description:
      "Reliable end-to-end browser testing for modern web applications",
    icon: "🎭",
  },
  {
    name: "Cypress",
  ...
  // Deployment
  {
    ...
    category: "deploy",
    description:
      "Zero-config deployment platform optimized for Next.js & static sites",
    icon: "▲",
    badge: "1-Click",
  },
  {
    ...
    category: "deploy",
    description:
      "Serverless execution environment deployed across global edge locations",
    icon: "☁️",
  },
  {
    ...
    category: "deploy",
    description:
      "JAMstack platform for frontend developers with instant deployments",
    icon: "⚡",
  },
  {
    ...
    category: "deploy",
    description:
      "Standardized container builds ready for AWS, GCP, or self-hosted VPS",
    icon: "🐳",
  },
];
        ...
        {filteredTech.length === 0 ? (
          <div className="text-center py-16 border border-border/60 rounded-xl bg-card/40 font-mono">
            ...
            <p className="text-sm text-foreground font-bold">
              No tech stack matches your query
            </p>
            <p className="text-xs text-muted-foreground mt-1">
              Try resetting search filter or choosing another category.
            </p>
            <button
              onClick={() => {
