      ...
      <div className="mb-8 flex flex-wrap items-center justify-between gap-4 sm:flex-nowrap">
        ...
        <div className="flex items-center gap-2">
          <span className="text-muted-foreground text-sm font-medium">
            ...
            {visibleSponsors.length === 1 ? "Sponsor" : "Sponsors"}
          </span>
        </div>
      </div>
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {specialSponsors.map((entry, index) => {
                  ...
                  return (
                    <div
                      key={entry.githubId}
                      className="group rounded-lg border border-border bg-card/50 transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5"
