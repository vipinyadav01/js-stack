...
const RuntimeSchema = z.enum(["none", "bun", "node", "workers", "deno"]);
...
const APISchema = z.enum(["none", "trpc", "orpc", "graphql", "rest"]);
const PackageManagerSchema = z.enum(["npm", "pnpm", "bun"]);
...
const WebDeploySchema = z.enum(["none", "cloudflare-pages", "alchemy"]);
const ServerDeploySchema = z.enum(["none", "cloudflare-workers", "alchemy"]);
...
export {
  ...
  copyBaseTemplate,
  copyFileOrDir,
  createProject as createCommand,
  createProject$1 as createProject,
